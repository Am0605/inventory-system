...
import { FileText, Plus, X, Search, Trash2, AlertTriangle } from 'lucide-react';
...
interface OrderItem {
    ...
    product: Product;
    quantity: number;
    unit_cost: number; // Changed from unit_price to unit_cost
    total: number;
}
...
export default function EditPurchaseOrder({ order, suppliers, products }: EditPurchaseOrderProps) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        items: orderItems.map(item => ({
            ...
            total: item.total,
        })) as { id?: number; product_id: number; quantity: number; unit_cost: number; total: number; }[],
    });
    ...
    const addProduct = (product: Product) => {
        ...
        if (existingItem) {
            ...
            const newItem: OrderItem = {
                ...
                product: product,
                quantity: 1,
                unit_cost: product.cost, // Use cost for purchase orders
                total: product.cost,
            };
                            ...
                            <div className="mb-6">
                                ...
                                <div className="bg-gray-50 rounded-lg p-3">
                                    <div className="text-sm">
                                        ...
                                        <div className="text-gray-500">Supplier: {order.supplier.name}</div>
